...
export const requireAuth = (Component) => {
  return (props) => {
    ...
    console.log('requireAuth props', props)
    const auth = useAuth();
    const authPath = "/auth/signin"
    const path = props.location.pathname !== authPath ? authPath + "?next=" + props.location.pathname : authPath
